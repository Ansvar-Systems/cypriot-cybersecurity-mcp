...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fcypriot-cybersecurity-mcp.svg)](https://www.npmjs.com/package/@ansvar/cypriot-cybersecurity-mcp)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![CI](https://github.com/Ansvar-Systems/cypriot-cybersecurity-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/cypriot-cybersecurity-mcp/actions/workflows/ci.yml)
...
**Endpoint:** `https://mcp.ansvar.eu/cypriot-cybersecurity/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add cypriot-cybersecurity-mcp --transport http https://mcp.ansvar.eu/cypriot-cybersecurity/mcp` |
...
```json
{
  "mcpServers": {
    "cypriot-cybersecurity-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/cypriot-cybersecurity/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/cypriot-cybersecurity-mcp
```
...
```json
{
  "mcpServers": {
    "cypriot-cybersecurity-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/cypriot-cybersecurity-mcp"]
    }
  }
}
```
