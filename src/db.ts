/**
 * SQLite database access layer for the Cypriot Cybersecurity (CSIRT-CY) MCP server.
 *
 * Schema:
 *   - guidance    — CSIRT-CY cybersecurity guidelines and technical recommendations
 *   - advisories  — CSIRT-CY security advisories and incident alerts
 *   - frameworks  — CSIRT-CY framework series (NIS2 guidance, cybersecurity recommendations)
 *
